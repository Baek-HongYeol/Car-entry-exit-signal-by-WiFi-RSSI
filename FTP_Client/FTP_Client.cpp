...
//######################################################################################################
void    FTP_Client::begin(const char* _serverAdress, const int _port, const  char* _userName, const char* _passWord, uint16_t _timeout)
{
...
bool    FTP_Client::openConnection(void)
{
    ...
    getFTPAnswer(ans);
    if(strstr(ans,"230-OK") == NULL && strstr(ans, "230") == NULL)
    {
        #ifdef FTP_DebugSerial
...
//######################################################################################################
bool FTP_Client::isAvailable(void)
{
    return isConnected;
}
//######################################################################################################